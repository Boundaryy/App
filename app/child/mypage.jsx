...
const MyPage = () => {
    ...
    const handleBackButtonClick = () => {
        router.push("/child/home"); // 뒤로가기 버튼 클릭 시 이전 화면으로 돌아갑니다.
    };

    return (
        <View style={globalStyles.container}>
            <TouchableOpacity style={globalStyles.backButton} onPress={handleBackButtonClick}>
                <Text style={globalStyles.backText}>뒤로가기</Text>
            </TouchableOpacity>
            <View style={globalStyles.header}>
                <Text style={globalStyles.subtitle}>마이페이지</Text>
                <Text style={globalStyles.description}>학습한 날을 확인해요</Text>
            </View>
